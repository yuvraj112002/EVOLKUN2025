...
import styles from '@styless/ServiceCommon.module.scss';
...
export default function WordPressForm() {
  ...
  return (
    <div className={styles.formContainer}>
      <h2 className={styles.heading}>Web Development Questionnaire</h2>

      <div className={styles.fieldGroup}>
        <label>1. What platform are you using?</label>
        <select className={styles.dropdown} value={platform} onChange={(e) => setPlatform(e.target.value)}>
